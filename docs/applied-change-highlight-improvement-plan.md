...
> 상태: Phase 1 구현 완료 (76ea2e7, 2026-09-23). 사용자 확인 완료.
> Phase 2(인라인 칩)는 보류 — Phase 1(메뉴바 클러스터)만으로 충분하다는 판단.
> 계획서 리뷰 지적 3건(active 클래스 삭제, n/m·aria 정의, 범위 선택 명시)은 본 문서에 반영済.
>
