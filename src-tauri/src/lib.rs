...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::project_memory::import_project_memory_items,
            ...
            commands::quality::log_quality_records,
            commands::quality::get_quality_records,
            commands::quality::update_quality_disposition,
            commands::quality::log_quality_run,
            commands::quality::load_quality_runs,
            commands::usage::log_ai_usage,
            commands::usage::get_ai_usage_daily,
            commands::usage::clear_ai_usage,
            ...
            commands::glossary::list_project_glossaries,
            commands::glossary::set_project_glossaries,
            commands::glossary::reorder_project_glossaries,
